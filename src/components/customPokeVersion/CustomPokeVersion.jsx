...
export default function CustomPokeVersion({entrie, index, setIndexFlavor}){
  ...
  return(
    <div class='version' ref={thisVersion} >
      <div className={entrie.version.name} onClick={()=>{clickVersion(index)}} onMouseLeave={()=>{setIsHover(false)}} onMouseOver={()=>{setDomData(thisVersion.current.getBoundingClientRect()); setIsHover(true)}}>
