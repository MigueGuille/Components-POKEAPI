  ...
  return(
    ...
    <>
      ...
      <>
        ...
        <div className='text-arrows text-prev-pokemon' onClick={prevPage} >{getNumber(id-1)+ ' ' + prevName}</div>
      </> : ''
      }
      </div>
      ...
      <>
        ...
        <div className='text-arrows text-next-pokemon' onClick={nextPage} >{getNumber(id+1) + ' ' + nextName}</div>
      </> : ''
      }
      </div>
    </>
